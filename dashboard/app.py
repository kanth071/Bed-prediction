...
def main():
    ...
    st.markdown(
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; padding:5px 0; margin-bottom:20px; border-bottom:1px solid var(--border-glass);">
            <div style="font-size:1.1rem; font-weight:800; letter-spacing:0.5px; color:var(--text-primary);">BEDFORECAST COMMAND CENTER <span style="color:var(--text-muted); font-weight:400; font-size:0.85rem;">| {selection.upper()}</span></div>
